...
function removeElement(event){
    ...
    let card = document.getElementsByClassName('card h-100')


    card.addEventListener('dblclick', removeElement)  
    ...
    //add an event listener on the weather display items to run this function
}



    
// let weatherCard = await document.getElementById('cardid')
    
// (weatherCard).addEventListener('dblclick', removeElement)    
